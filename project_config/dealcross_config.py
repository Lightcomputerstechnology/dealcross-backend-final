...
class # File: project_config/dealcross_config.py
...
logger.info(f"✅ REDIS_URL: {settings.redis_url}")# File: project_config/dealcross_config.py
...
# Structured log confirmation on startup
logger.info("✅ Dealcross settings loaded successfully.")
logger.info(f"✅ REDIS_URL: {settings.redis_url}")(BaseSettings):
    # GENERAL
    APP_NAME: str = Field(..., alias="APP_NAME")
    APP_ENV: str = Field(..., alias="APP_ENV")
    APP_PORT: int = Field(..., alias="APP_PORT")
